...
export function AddTimeSloat() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await post("/timeSlots", newValue, true);
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Add Time Slot</h4>
            </div>
            {/* <div>
              <button
                type="button"
            ...
            <div className="card-body">
              <form className="forms-sample" onSubmit={handleSubmit}>
                <div className="row">
                  ...
                  <div className="">
                    <SubmitButton loading={false} text="Add Time Slot" />
                  </div>
                </div>
              </form>
            </div>
