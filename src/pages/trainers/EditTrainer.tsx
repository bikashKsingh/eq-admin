...
export function EditTrainer() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await put(`/trainers/${id}`, newValue);
    ...
    function () {
      async function getData(id: string) {
        ...
        if (apiResponse?.status == 200) {
          ...
          apiData.specialities = apiData?.specialities?.map(
            (sepciality: any) => {
              return {
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Update Trainer</h4>
            </div>
            {/* <div>
              <button
                type="button"
          ...
          <form className="forms-sample" onSubmit={handleSubmit}>
            ...
            <div className="card rounded-2 mt-4">
              <div className="card-body">
                ...
                <SubmitButton loading={false} text="Update Trainer" />
              </div>
            </div>
          </form>
        </div>
