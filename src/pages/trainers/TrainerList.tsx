...
export function TrainerList() {
  ...
  useEffect(
    function () {
      async function getData() {
        setLoading(true);
        let url = `/trainers?page=${pagination.page}&limit=${pagination.limit}`;
          ...
          return (
            <div className="d-flex gap-1">
              ...
              <Link
                className="p-2 bg-light"
                to={{
                  pathname: `/trainers/details/${value}`,
                }}
              >
                <span
  ...
  async function handleDeleteData(recordId: string | string[]) {
    ...
    if (Array.isArray(recordId)) {
      apiResponse = await remove(`/trainers`, recordId);
    } else {
      apiResponse = await remove(`/trainers/${recordId}`);
    }
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Trainers</h4>
            </div>
            <div>
              <Link
                to={"/trainers/add"}
