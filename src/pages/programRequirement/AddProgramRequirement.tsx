...
import {
  programRequirementInitialValues,
  programRequirementSchema,
  ProgramRequirementValues,
} from "../../validationSchemas/programRequirementSchema";

export function AddProgramRequirement() {
  ...
  const {
    ...
    onSubmit: async function (
      values: ProgramRequirementValues,
      helpers: FormikHelpers<ProgramRequirementValues>
    ) {
      setLoading(true);

      const apiResponse = await post("/programRequirements", values, true);
    ...
    initialValues: programRequirementInitialValues,
    validationSchema: programRequirementSchema,
  });
