    ...
    <div className="content-wrapper">
      ...
      <div className="row">
        ...
        <div className="col-md-3 grid-margin stretch-card">
          ...
          >
            <div className="card-body">
              <p className="card-title text-xl-left">Total Users</p>
        ...
        <div className="col-md-3 grid-margin stretch-card">
          ...
          >
            <div className="card-body">
              <p className="card-title text-xl-left">Total Sales</p>
              <div className="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                <h3 className="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">
                  2000
                </h3>
        ...
        <div className="col-md-3 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <p className="card-title text-xl-left">Total Franchise</p>
              <div className="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                <h3 className="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">
                  10
                </h3>
        ...
        <div className="col-md-3 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <p className="card-title text-xl-left">Total Leads</p>
              <div className="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                <h3 className="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">
                  1000
                </h3>
