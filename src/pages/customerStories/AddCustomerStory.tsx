import { GoBackButton, InputBox, SubmitButton, TextareaBox } from "../../components";
import { FormikHelpers, useFormik } from "formik";
import { Link, useNavigate } from "react-router-dom";
import { useState } from "react";
import { toast } from "react-toastify";
import { API_URL } from "../../constants";
import { post, remove, validateNumber } from "../../utills";
import {
...
export function AddCustomerStory() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await post("/customerStories", values, true);
      ...
      <div className="row">
        <div className="col-md-12 grid-margin">
          <div className="d-flex gap-2 align-items-center">
            <GoBackButton />
            <h4 className="font-weight-bold mb-0">Add Customer Story</h4>
          </div>
        </div>
      </div>
          ...
          <div className="card rounded-2">
            <div className="card-body">
              <form className="forms-sample" onSubmit={handleSubmit}>
                ...
                <SubmitButton loading={loading} text="Add Customer Story" />
              </form>
            </div>
          </div>
        </div>
