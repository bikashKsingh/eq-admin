...
export function AddBookingTimeSlot() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await post("/bookingTimeSlots", newValues, true);
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Add Booking Time Slot</h4>
            </div>
            {/* <div>
              <button
                type="button"
          ...
          <div className="card rounded-2">
            <div className="card-body">
              <form className="forms-sample" onSubmit={handleSubmit}>
                ...
                <SubmitButton loading={false} text="Add Booking Time Slot" />
              </form>
            </div>
          </div>
        </div>
