        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">My Profile</h4>
            </div>
            <div>
              <Link
                type="button"
                to={"/trainer/updateProfile"}
                className="btn btn-primary text-light btn-icon-text btn-rounded"
              >
                <i className="ti-pencil-alt btn-icon-prepend"></i>Edit Profile
              </Link>
            </div>
          </div>
        </div>
