...

      {
        ...
        Cell: ({ value }: any) => {
          return (
            <div className="">
              <a
                href={`tel:${value.country}-${value.mobile}`}
                className="p-0 m-0 d-block mb-2"
              >
                {value.country}-{value.mobile}
              </a>
              <a href={`mailto:${value.email}`} className="p-0 m-0 d-block">
                {value.email}
              </a>
            </div>
          );
                    ...
                    >
                      ...
                      <li className="d-flex px-3 gap-2">
                        <input
                          type="radio"
                          id="positionContactpage"
                          value={"TALK_TO_EXPERT_PAGE"}
                          name="position"
                          onChange={handleSetposition}
                        />
                        <label htmlFor="positionContactpage">
                          TOAK TO YOGA EXPERT PAGE
                        </label>
                      </li>
                      <li className="d-flex px-3 gap-2">
                        <input
